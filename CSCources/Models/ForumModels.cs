...
namespace CSCources.Models
{
    ...
    /// <summary>
    /// поток сообщений, например поток сообщений в статье, или поток сообщений к группе курса, или поток сообщений на форуме ( один форум соответсвует одному потоку )
    /// </summary>
    public class Thread
    {
